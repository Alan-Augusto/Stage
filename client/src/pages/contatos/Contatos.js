            ...
            <main className='contatos'>
                <div className='form'>
                    ...
                    <form onSubmit={whenSubmit}>
                        ...
                        <label style={{ marginTop: '10px', marginBottom: '-6px' }}> Por onde prefere ser respondido? </label>
                        <p>
                            <input type='radio' name='gender' value="whatsapp" onChange={(e) => setContactMethod(e.target.value)} required /> Whatsapp
                            <input type='radio' name='gender' value="telefone" onChange={(e) => setContactMethod(e.target.value)} required /> Telefone
                            <input type='radio' name='gender' value="email" onChange={(e) => setContactMethod(e.target.value)} required /> Email
                        </p>
